...
// ------ (ضع هنا قيمك الخاصة) ------
export const SUPABASE_URL = 'https://aefiigottnlcmjzilqnh.supabase.co'; // <-- استبدل هذا
export const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFlZmlpZ290dG5sY21qemlscW5oIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDcxNzY2MDQsImV4cCI6MjA2Mjc1MjYwNH0.FypB02v3tGMnxXV9ZmZMdMC0oQpREKOJWgHMPxUzwX4'; // <-- استبدل هذا
// -----------------------------------
